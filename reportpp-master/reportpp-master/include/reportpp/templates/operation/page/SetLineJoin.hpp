...
#ifndef PDF_PAGE_SETLINEJOIN_OPERATION_H
#define PDF_PAGE_SETLINEJOIN_OPERATION_H

#include "../Operation.hpp"

class SetLineJoin: public Operation {
public:
  SetLineJoin(HPDF_LineJoin line_join):
    Operation(),
  ...
  void init(ReportGlobals &glob) {
    HPDF_Page_SetLineJoin(glob.pages.back(), line_join_);
  }
...
private:
  HPDF_LineJoin line_join_;

};

#endif /* ifndef PDF_PAGE_SETLINEJOIN_OPERATION_H */