...
#ifndef PDF_PAGE_SETWORDSPACE_OPERATION_H
#define PDF_PAGE_SETWORDSPACE_OPERATION_H

#include "../Operation.hpp"

class SetWordSpace: public Operation {
public:
  SetWordSpace(HPDF_REAL value):
    Operation(),
    value_(value),
  ...
  void init(ReportGlobals &glob) {
    HPDF_Page_SetWordSpace(glob.pages.back(), value_);
  }
...
#endif /* ifndef PDF_PAGE_SETWORDSPACE_OPERATION_H */