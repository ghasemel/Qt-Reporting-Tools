...
#ifndef PDF_PAGE_SETLINECAP_OPERATION_H
#define PDF_PAGE_SETLINECAP_OPERATION_H

#include "../Operation.hpp"

class SetLineCap: public Operation {
public:
  SetLineCap(HPDF_LineCap line_cap):
    Operation(),
    line_cap_(line_cap),
  ...
  void init(ReportGlobals &glob) {
    HPDF_Page_SetLineCap(glob.pages.back(), line_cap_);
  }
...
private:
  HPDF_LineCap line_cap_;

};

#endif /* ifndef PDF_PAGE_SETLINECAP_OPERATION_H */