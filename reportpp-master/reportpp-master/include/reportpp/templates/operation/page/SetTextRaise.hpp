...
#ifndef PDF_PAGE_SETTEXTRAISE_OPERATION_H
#define PDF_PAGE_SETTEXTRAISE_OPERATION_H

#include "../Operation.hpp"

class SetTextRaise: public Operation {
public:
  SetTextRaise(HPDF_REAL value):
    Operation(),
    value_(value),
  ...
  void init(ReportGlobals &glob) {
    HPDF_Page_SetTextRaise(glob.pages.back(), value_);
  }
...
#endif /* ifndef PDF_PAGE_SETTEXTRAISE_OPERATION_H */