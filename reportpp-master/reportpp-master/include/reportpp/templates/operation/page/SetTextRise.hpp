...
#ifndef PDF_PAGE_SETTEXTRISE_OPERATION_H
#define PDF_PAGE_SETTEXTRISE_OPERATION_H

#include "../Operation.hpp"

class SetTextRise: public Operation {
public:
  SetTextRise(HPDF_REAL value):
    Operation(),
    value_(value),
  ...
  void init(ReportGlobals &glob) {
    HPDF_Page_SetTextRise(glob.pages.back(), value_);
  }
...
#endif /* ifndef PDF_PAGE_SETTEXTRISE_OPERATION_H */