...
#ifndef PDF_PAGE_SETCHARSPACE_OPERATION_H
#define PDF_PAGE_SETCHARSPACE_OPERATION_H

#include "../Operation.hpp"

class SetCharSpace: public Operation {
public:
  SetCharSpace(HPDF_REAL value):
    Operation(),
    value_(value),
  ...
  void init(ReportGlobals &glob) {
    HPDF_Page_SetCharSpace(glob.pages.back(), value_);
  }
...
#endif /* ifndef PDF_PAGE_SETCHARSPACE_OPERATION_H */