...
#ifndef PDF_SETPAGEMODE_OPERATION_H
#define PDF_SETPAGEMODE_OPERATION_H

#include "../Operation.hpp"

class SetPageMode: public Operation {
public:
  SetPageMode(HPDF_PageMode mode):
    Operation(),
    mode_(mode),
...
#endif /* ifndef PDF_SETPAGEMODE_OPERATION_H */